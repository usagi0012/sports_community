...
function searchCoordinateToAddress(latlng) {
    ...
    naver.maps.Service.reverseGeocode({
        ...
        htmlAddresses.push('<br/><strong>위도:</strong> ' + latlng.lat() + '<br/><strong>경도:</strong> ' + latlng.lng());
...
function searchAddressToCoordinate(address) {
    naver.maps.Service.geocode({
        ...
        htmlAddresses.push('<br/><strong>위도:</strong> ' + point.y + '<br/><strong>경도:</strong> ' + point.x);
...
function initGeocoder() {
    ...
    $('#confirm').on('click', function(e) {
        ...
        naver.maps.Service.reverseGeocode({
            ...
            alert('지번주소: ' + jibunAddress + '도로면주소: ' + roadAddress);
        });
    });
